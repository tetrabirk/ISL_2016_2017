var birk = addUtilisateur('leyens','ludovic','ludovic.leyens@gmail.com','Birk','password');
var boby = addUtilisateur('robert','boberss','bob.bobberson1@gmail.com','Boby','password');
var anto = addUtilisateur('Tonnus','anthony','anthony.tonnus@gmail.com','Anto','password');
var july = addUtilisateur('Jamesson','julie','julie.jammeson@gmail.com','July','password');

var title_1="Titre d'article ! woaw";
...
var article1 = new Article(title_1,txt_1,birk);
