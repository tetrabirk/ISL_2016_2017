...
switch($get_action){
    ...
    case "update":
        ...
        $data_value = getItem($get_item_id);
                       
        $data_value["menu"]         = $post_menu          = $data_value[0]["item_menu"]; 
        $data_value["titre"]        = $post_titre         = $data_value[0]["item_title"]; 
        $data_value["sous_titre"]   = $post_sous_titre    = $data_value[0]["item_subtitle"];
        $data_value["description"]  = $post_description   = $data_value[0]["item_description"];
        $data_value["in_menu"]      = $post_in_menu       = $data_value[0]["in_menu"];
